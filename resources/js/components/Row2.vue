            ...
            <div class="col-xl-8 col-lg-7">
                <div class="card shadow mb-4">
                    ...
                    <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                        <h6 class="m-0 font-weight-bold text-black">Attendance Overview {{ this.school }}</h6>
                        <div class="dropdown no-arrow">
                            ...
                            <div class="dropdown-menu dropdown-menu-right shadow animated--fade-in" aria-labelledby="dropdownMenuLink" x-placement="bottom-end" style="position: absolute; will-change: transform; top: 0px; left: 0px; transform: translate3d(17px, 19px, 0px);">
                                ...
                                <a class="dropdown-item" :href="'http://fcatdata/rs/Pages/ReportViewer.aspx?%2fFCAT+Data+SSRS%2fAttendanceWeekly19&school=' + this.school + '&rs:Command=Render'" onclick="return !window.open(this.href, 'Key Group Students by Week', 'width=1024,height=768')"><i class="fas fa-angle-double-right fa-fw"></i>&nbsp;&nbsp;Weekly Attendance by Year</a>
                                <a class="dropdown-item" :href="'http://fcatdata/rs/Pages/ReportViewer.aspx?%2fFCAT+Data+SSRS%2fAttendanceWeekly19&school=' + this.school + '&rs:Command=Render&rc:Section=2'" onclick="return !window.open(this.href, 'Key Group Students by Week', 'width=1024,height=768')"><i class="fas fa-angle-double-right fa-fw"></i>&nbsp;&nbsp;Weekly Attendance by PP</a>
                                ...
                                <a class="dropdown-item" :href="'http://fcatdata/rs/Pages/ReportViewer.aspx?%2fFCAT+Data+SSRS%2fAttendanceStudentWeekly19&school=' + this.school + '&rs:Command=Render'" onclick="return !window.open(this.href, 'Key Group Students by Week', 'width=1024,height=768')"><i class="fas fa-angle-double-right fa-fw"></i>&nbsp;&nbsp;Weekly Attendance by Student</a>
                            </div>
                        </div>
                    </div>
                    <!-- Card Body -->
...
<script>
    export default {
        ...
        data() {
            return {
                // schoolparam: '&school=' . this.school . '&rs',
            };
        },
        mounted() {
